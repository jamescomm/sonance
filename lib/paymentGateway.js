...
exports.paynow = function(req, res) {
    ...
    else
    {
                          var payment = {
                            ...
                            "redirect_urls": {
                                "return_url": "http://199.188.204.100:5000/exchanges/api/v1/transection/success?userId="+req.query.userId+"&amount="+req.query.amount,
                                "cancel_url": "http://199.188.204.100:5000/exchanges/api/v1/transection/cancel"
                            },
                            "transactions": [{
                                "amount": {
