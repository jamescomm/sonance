...
let updateEther = function(user_id,currency,amountToUpdate,ether,callback)
{
  Currencies.findOneAndUpdate({'currencies.currency':currency,userId:user_id},{'currencies.$.balance':amountToUpdate,'currencies.$.ether':ether},{new:true})
  .then((response)=>{
    if(response)
    {
      var found = response.currencies.find((element)=>{return element.currency == currency});
...
{
let verificationURL = 'https://cryptokenxchange.com:5001/exchanges/api/v1/user/verifyEmail?userId='+id
...
let mailOptions = {
      from: 'cryptoexchange18@gmail.com', // sender address
      to: to, // list of receivers
      subject: 'Welcome to Crypto-Exchange!!!', // Subject line
      html: `
                              ...
                              <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                <td class="content-wrap" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 20px;" valign="top">
                                  ...
                                  <table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    ...
                                    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                      <td class="content-block" itemprop="handler" itemscope itemtype="http://schema.org/HttpActionHandler" style="f
ont-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                        valign="top">
                              ...
                              <table width="100%" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                  <td class="aligncenter content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 12px; vertical-align: top; color: #999; text-align: center; margin: 0; padding: 0 0 20px;" align="center"
                                    valign="top">Follow <a href="http://twitter.com/bitwirex" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 12px; color: #999; text-decoration: underline; margin: 0;">@Cryptokenxchange</a> on Twitter.</td>
                                </tr>
                              </table>
                            </div>
                          </div>
