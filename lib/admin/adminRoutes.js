...
admRoutr.route("/blockedIp")
    .get([ /*middleware.authenticate.autntctTkn*/ ], function(req, res) {
        adminServices.blockedIp(req, res);
    });
admRoutr.route("/addApiContent")
    .post([ /*middleware.authenticate.autntctTkn*/ ], function(req, res) {
        adminServices.addApiContent(req, res);
    });
admRoutr.route("/getApiContent")
    .get([ /*middleware.authenticate.autntctTkn*/ ], function(req, res) {
        adminServices.getApiContent(req, res);
    });
admRoutr.route("/removeApiContent")
    .post([ /*middleware.authenticate.autntctTkn*/ ], function(req, res) {
        adminServices.removeApiContent(req, res);
    });
admRoutr.route("/addQuestionAns")
    .post([ /*middleware.authenticate.autntctTkn*/ ], function(req, res) {
        adminServices.addQuestionAns(req, res);
    });
admRoutr.route("/getQuestionAns")
    .get([ /*middleware.authenticate.autntctTkn*/ ], function(req, res) {
        adminServices.getQuestionAns(req, res);
    });
admRoutr.route("/removeQuestionAns")
    .post([ /*middleware.authenticate.autntctTkn*/ ], function(req, res) {
        adminServices.removeQuestionAns(req, res);
    });
admRoutr.route("/blockIp")
    .get([ /*middleware.authenticate.autntctTkn*/ ], function(req, res) {
        adminServices.blockIp(req, res);
    });
    admRoutr.route("/unblockIp")
    .get([ /*middleware.authenticate.autntctTkn*/ ], function(req, res) {
        adminServices.unblockIp(req, res);
    });
...
admRoutr.route("/usercount")
    ...
    admRoutr.route("/updateFee")
    .post([ /*middleware.authenticate.autntctTkn*/ ], function(req, res) {
    adminServices.updateFee(req, res);
    });
    admRoutr.route("/subadmin")
    .post([ /*middleware.authenticate.autntctTkn*/ ], function(req, res) {
    adminServices.subadmin(req, res);
    });
