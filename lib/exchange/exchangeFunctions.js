...
let exchangeAsk = (Ask,User,userCurrency,callback)=>{
	...
	if(Ask.volume.value > userCurrency.balance)
	{
		console.log("in insufficient amount callback")
		return callback("Sorry, you don't have sufficient amount for this Ask.")
	}
	else
	{
		console.log("in exchange when user having balance to proceed for ask")
