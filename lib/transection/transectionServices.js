...
//****************************required functions************************ 
function transaction(req,res,user_id,transaction_id,amount,sendTo)
{
    Transaction.insert({user_id:user_id,transaction_id:transaction_id,amount:amount,sendTo:sendTo})
    .then((success)=>{
        if(success)
